  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative w-full z-20 pt-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
            <a
              href='#portfolio'
              className='px-8 py-4 text-lg bg-white
              text-black hover:bg-white/90 rounded-full transform hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:shadow-xl min-w-[200px]'
            >
              View Portfolio
            </a>
            ...
            <a
              href='#contact'
              className='px-8 py-4 text-lg border-2 border-white text-white hover:bg-white/10 rounded-full transform hover:-translate-y-0.5
      ...
      <div className='absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 z-20 animate-bounce hidden sm:block'>
        <div className='w-6 h-10 sm:w-8 sm:h-14 rounded-full border-2 border-white/30 flex items-start justify-center p-2'>
          <div className='w-1 h-2 sm:h-3 bg-white/60 rounded-full animate-scroll' />
        </div>
      </div>
    </section>
  );
